...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("grep", "Search historical messages in lossless context DB", "Info",
               args_hint="<query>", aliases=("lossless_grep", "lg")),
    CommandDef("stats", "Show lossless context DB stats", "Info"),
